...
interface ExhibitionOrganizerProps {
...
export function ExhibitionOrganizer({ organizer, showSocial }: ExhibitionOrganizerProps) {
          ...
          <div className="p-5 sm:p-6">
            <div className="flex items-center gap-4">
              {organizer.logoUrl?.trim() ? (
                ...
                <div className="flex size-14 shrink-0 items-center justify-center rounded-xl bg-teal-100 text-xl font-black text-teal-500">
              ...
              <div className="mt-4 flex flex-wrap gap-2 border-t border-gray-100 pt-4">
                {allLinks.map(({ Icon, href, label }) => (
                  <a
                    ...
                    className="flex items-center gap-1.5 rounded-lg bg-gray-100 px-3 py-1.5 text-[12px] font-semibold text-gray-600 transition-all hover:bg-teal-50 hover:text-teal-700"
                  >
