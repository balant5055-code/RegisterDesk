...
export default function IdentifierMigrationPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* RD-RESPONSIVE-06 — the track list is underscore-separated, not comma-separated.
          Tailwind maps `_` to a space inside an arbitrary value; a comma is emitted verbatim,
          producing `grid-template-columns: auto,1fr`, which is invalid. The browser dropped
          the whole declaration, so this collapsed to a single implicit column.
          `minmax(0,1fr)` on the flexible track keeps a wide child from forcing overflow. */}
      <section className="grid gap-3 sm:grid-cols-[auto_minmax(0,1fr)]">
