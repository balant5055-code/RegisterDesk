...
import {
  Loader2, ExternalLink, RefreshCw, Building2, Mail, Phone, Users,
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          {/* RD-ADMIN-CLOSURE-01 · the shared breadcrumb component, replacing a hand-rolled
              back link. Same destination as before — this one was already correct — but now
              it states the hierarchy rather than only offering a way out of it, and matches
              Event 360 beside it. */}
          <Breadcrumbs
            className="mb-1"
            items={[
              { label: 'Organizers', href: ROUTES.ADMIN_ORGANIZERS },
              {
                label: overview?.profile.name
                  || overview?.profile.organizationName
                  || organizerUid,
              },
            ]}
          />
